defmodule ExModbus.Types do
  ...
  def from_binary(<<bitfield::unsigned-integer-size(32)-big>>, :bitfield32), do: {:ok, bitfield}
  def from_binary(<<bitfield::unsigned-integer-size(16)-big>>, :bitfield16), do: {:ok, bitfield}
  def from_binary(<<int::signed-integer-size(16)-big>>,        :int16),      do: {:ok, int}
  def from_binary(<<uint::unsigned-integer-size(16)-big>>,     :enum16),     do: {:ok, uint}
  def from_binary(<<uint::unsigned-integer-size(16)-big>>,     :uint16),     do: {:ok, uint}
  def from_binary(<<uint::unsigned-integer-size(32)-big>>,     :uint32),     do: {:ok, uint}
  def from_binary(<<sf::signed-integer-size(16)-big>>,         :sunssf),     do: {:ok, sf}
  def from_binary(<<sf::signed-integer-size(32)-big>>,         :sunssf),     do: {:ok, sf}
  def from_binary(<<flt::float-size(32)-big>>,                 :float32),    do: {:ok, flt}
  def from_binary(<<uint::unsigned-integer-size(32)-big>>,     :acc32),      do: {:ok, uint}
  ...
  def to_binary(data, :int16, _), do: {:ok, <<data::signed-integer-size(16)-big>>}
  def to_binary(data, :uint16, _) when data >= 0, do: {:ok, <<data::unsigned-integer-size(16)-big>>}
  ...
  def to_binary(data, :enum16, enum_map) when is_integer(data) do
    case Map.has_key?(enum_map, data) do
      true -> {:ok, <<data::unsigned-integer-size(16)-big>>}
  ...
  def to_binary(data, :enum16, enum_map) when is_binary(data) do
    ...
    case Map.has_key?(flipped_map, data) do
      true -> {:ok, <<Map.fetch!(flipped_map, data)::unsigned-integer-size(16)-big>>}
