defmodule ExModbus.TestDevice do
  ...
  field :a_sf,           :sunssf,   40076,  2, :r,  "AC current scale factor", "SF"
  field :var,            :int16,    40090,  1, :r,  "(VAr) Reactive power", "Var"
  field :unk_type,       :unknown,  40098,  1, :r,  "Unknown type", "googles"
  field :enum_test,      :enum16,   40099,  1, :r,  "Enum Test", "", %{1 => "OFF", 2 => "On"}
  field :enum_test_fail, :enum16,   40100,  1, :r,  "Enum Test", "", %{1 => "OFF", 2 => "On"}
  field :conn_win_tms,   :uint16,   40230,  1, :rw, "Time window for connect/disconnect (0-300 seconds)", "S"
end
